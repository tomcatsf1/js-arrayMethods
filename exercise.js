...
var unity = westSide.concat(eastSide);
...
var unFriend = fbFriends.slice(1, 4,); // would'nt 4 technically be Leberon? Why did I need to add 4 to get Lamar on the unFriend list??
